...
namespace CardFramework
{
    public abstract class CardsGame
    {
        ...
        public virtual int CardValue(TraditionalCard card)
        {
            switch (card.Value)
            {
                case CardFramework.CardValue.Ace:
                    return 1;
                case CardFramework.CardValue.Two:
                    return 2;
                case CardFramework.CardValue.Three:
                    return 3;
                case CardFramework.CardValue.Four:
                    return 4;
                case CardFramework.CardValue.Five:
                    return 5;
                case CardFramework.CardValue.Six:
                    return 6;
                case CardFramework.CardValue.Seven:
                    return 7;
                case CardFramework.CardValue.Eight:
                    return 8;
                case CardFramework.CardValue.Nine:
                    return 9;
                case CardFramework.CardValue.Ten:
                    return 10;
                case CardFramework.CardValue.Jack:
                    return 11;
                case CardFramework.CardValue.Queen:
                    return 12;
                case CardFramework.CardValue.King:
                    return 13;
                default:
        ...
        public void LoadContent()
        {
            ...
            CardPacket fullDeck = new CardPacket(1, 2, CardSuit.AllSuits,
                CardFramework.CardValue.NonJokers | CardFramework.CardValue.Jokers);
            string assetName;
